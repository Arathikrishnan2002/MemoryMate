...
class ChangePasswordDialog1 extends StatefulWidget {
  @override
  _ChangePasswordDialog1State createState() => _ChangePasswordDialog1State();
}

class _ChangePasswordDialog1State extends State<ChangePasswordDialog1> {
