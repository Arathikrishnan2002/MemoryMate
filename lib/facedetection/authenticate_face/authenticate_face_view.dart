...
import 'package:memorymate/facedetection/authenticate_face/user_details_view.dart';
  ...
  _fetchUsersAndMatchFace() {
    FirebaseFirestore.instance.collection("users").get().catchError((e) {
      ...
      if (snap.docs.isNotEmpty) {
        ...
        _showFailureDialog(
          title: "No Visitor Registered",
          description:
              "Make sure the visitor is  registered first before verifying.",
        );
      }
    });
  }
    ...
    FirebaseFirestore.instance
      ...
      if (snap.docs.isNotEmpty) {
        ...
        _showFailureDialog(
          ...
          description:
              "Visitor is not registered yet. Do you want to regisiter ?.",
        );
      }
    });
  }
